...
*/
DROP DATABASE IF EXISTS projects_routine;
CREATE DATABASE IF NOT EXISTS projects_routine;
USE projects_routine;
...
ALTER TABLE Work_Done ADD CONSTRAINT Work_Done_Employee_FK FOREIGN KEY (EmployeeID) REFERENCES Employee (EmployeeID) ON DELETE CASCADE;
ALTER TABLE Work_Done ADD CONSTRAINT Work_Done_ProjectModule_FK FOREIGN KEY (ModuleID) REFERENCES Project_Modules (ModuleID) ON DELETE CASCADE;
ALTER TABLE Project_Modules ADD CONSTRAINT Project_Modules_Projects_FK FOREIGN KEY (ProjectID) REFERENCES Projects (ProjectID) ON DELETE CASCADE;
ALTER TABLE Employee ADD CONSTRAINT Employee_Employee_FK FOREIGN KEY (SuperVisorID) REFERENCES Employee (EmployeeID) ON DELETE CASCADE;
...
VALUES ('Lashinbang', '2018/3/10', 'Documentation OCR', 'Documentation OCR use Computer Vision', '2019/1/1'),
